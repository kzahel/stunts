...
This document is a build-focused reference for recreating the _feel_ and feature set of the original DOS game: driving, track editor, terrain/horizon, opponents, replay system, UI affordances, and the canonical content library (cars + track pieces).
...
- Keep their _personality_ mostly in pacing + consistency.
