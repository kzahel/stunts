...
export class UIManager {
    ...
    public showOptionsScreen(onBack: () => void, onMainMenu?: () => void, backLabel: string = 'Back') {
        this.clearScreens();
        ...
        [0, 1, 2, 3].forEach(playerId => {
            ...
            select.onchange = async () => {
                await this.settingsManager.updatePlayerControl(playerId, { type: select.value as ControlType });
            };
